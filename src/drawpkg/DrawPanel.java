...
public class DrawPanel extends javax.swing.JPanel {
    ...
    public void selectShape(int index) {
        shapeSelected =  shapesList.get(index);
    ...
    public void cloneShape(ShapeRender s){
        shapeCloned = (ShapeRender)(s).clone();
    ...
    public void paintComponent(Graphics g){
        ...
        if (shapeSelected!=null) DrawSelect(g2);
    ...
    private void MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MousePressed
        ...
        if (mode.equals("move")) {
            for(int i=shapesList.size()-1;i>=0;i--) {
                if(!(shapesList.get(i).getClass().getName().equals("shapespkg.Polyline"))) {
                    if (((Shape)shapesList.get(i)).contains(p1)) {
                        selectShape(i);
                        cloneShape(shapeSelected);
                        moved = true;
                        px = p1.x ; py = p1.y;
                        break;
                    }
    ...
    private void MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MouseReleased
        ...
        if (mode.equals("move")) {
            if (moved) {
            shapeSelected.updateLocation(p2.x-p1.x, p2.y-p1.y);
            shapeCloned = null;
            shapesList.remove(shapesList.size()-1); // remove shapeCloned from shapesList
