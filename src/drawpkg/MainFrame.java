...
import shapespkg.Bordered;
import shapespkg.Line;
import shapespkg.Rrectangle;
import shapespkg.Polyline;
import shapespkg.Ellipse;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void setColor(Color cl) {
        if (drawPanel1.shapeSelected!=null) {
            drawPanel1.shapeSelected.setColor(cl);
            repaint();
        }
    ...
    public void updateProperties(){
        if (drawPanel1.shapeSelected!=null) {
            ...
            Color c = ((Bordered)drawPanel1.shapeSelected).getBorderColor();
            PropPanel.setVisible(true);
            SizePanel.setVisible(true);
            BorderColorButton.setBackground(c);
            jSpinner1.getModel().setValue((int)((Bordered)drawPanel1.shapeSelected).getBorderSize());
            jComboBox1.setSelectedItem(((Bordered)drawPanel1.shapeSelected).getBorderType());
            SliderWidth.setValue((int)
                    ((RectangularShape)drawPanel1.shapeSelected).getWidth()
            );
            SliderHeight.setValue((int)
                    ((RectangularShape)drawPanel1.shapeSelected).getHeight()
            );
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
       int rVal = jFileSave.showOpenDialog(this);
       if (rVal == javax.swing.JFileChooser.APPROVE_OPTION) {
        String fileopen = (jFileSave.getSelectedFile().getPath());
        ...
        try {
            ...
            drawPanel1.shapesList = (Vector)in.readObject();
            for (int i=0;i!=drawPanel1.shapesList.size();i++) {
                Object[] line = {i, drawPanel1.shapesList.get(i).getName(), drawPanel1.shapesList.get(i).isVisible()};
                jTableModel.addRow(line);
            }
            
            Polyline.nbr = (int)in.readObject();
            Line.nbr = (int)in.readObject();
            Rrectangle.nbr = (int)in.readObject();
            Ellipse.nbr = (int)in.readObject();
        ...
        else if (rVal == javax.swing.JFileChooser.CANCEL_OPTION) {
            System.out.println("You pressed cancel");
      }
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void SaveMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveMenuItemActionPerformed
       int rVal = jFileSave.showSaveDialog(this);
       if (rVal == javax.swing.JFileChooser.APPROVE_OPTION) {
        filename = (jFileSave.getSelectedFile().getPath());
        System.out.println(filename);
        try {
            FileOutputStream file = new FileOutputStream(filename);
            ObjectOutputStream out = new ObjectOutputStream(file);
            
            out.writeObject(drawPanel1.shapesList);
            out.writeObject(Polyline.nbr);
            out.writeObject(Line.nbr);
            out.writeObject(Rrectangle.nbr);
            out.writeObject(Ellipse.nbr);
        ...
        //dir = (jFileSave.getCurrentDirectory().toString());
    ...
    private void BorderColorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BorderColorButtonActionPerformed
        ...
        if (drawPanel1.shapeSelected!=null)
        {
            ((Bordered)drawPanel1.shapeSelected).setBorderColor(color);
            repaint();
        }
        else
        drawPanel1.shapeBorderColor = color;
    ...
    private void jSpinner1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSpinner1StateChanged
        ...
        if (drawPanel1.shapeSelected!=null) {
            ((Bordered)drawPanel1.shapeSelected).setBorderSize(value);
            repaint();
        }
        else {
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if (drawPanel1.shapeSelected!=null) {
            ((Bordered)drawPanel1.shapeSelected).setBorderType((String)jComboBox1.getSelectedItem());
            repaint();
        }
        else {
    ...
    private void SliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_SliderStateChanged
        ...
        if (drawPanel1.shapeSelected!=null) {
            ...
            if (drawPanel1.shapeSelected instanceof Rrectangle)
            ((Rectangle)drawPanel1.shapeSelected).width = width ;
            else if (drawPanel1.shapeSelected instanceof Ellipse)
            ((Ellipse)drawPanel1.shapeSelected).width = width ;
    ...
    private void SliderHeightStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_SliderHeightStateChanged
        if (drawPanel1.shapeSelected!=null) {
            ...
            if (drawPanel1.shapeSelected instanceof Rrectangle)
            ((Rectangle)drawPanel1.shapeSelected).height = height ;
            else if (drawPanel1.shapeSelected instanceof Ellipse)
            ((Ellipse)drawPanel1.shapeSelected).height = height ;
